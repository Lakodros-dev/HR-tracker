...
async def handle_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id == config.ADMIN_ID:
        keyboard = [
            [InlineKeyboardButton("👥 Kutish ro'yxati", callback_data="pending_users")],
            [InlineKeyboardButton("📊 Hodimlar holati", callback_data="admin_status")],
            [InlineKeyboardButton("🗑 Hodimni o'chirish", callback_data="remove_employee")]
        ]
        reply_markup = InlineKeyboardMarkup(keyboard)
        
        await update.message.reply_text(
            f"👋 Xush kelibsiz, Admin!\n\n"
            f"Siz admin sifatida tizimni boshqarasiz.\n\n"
...
async def show_pending_users(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Kutish ro'yxatidagi foydalanuvchilarni ko'rsatish"""
    ...
    try:
        await context.bot.send_message(
            ...
            text="🎉 Tabriklaymiz!\n\n"
                 ...
                 "📍 Lokatsiya yuborish uchun pastdagi tugmani bosing."
        )
    except Exception as e:
